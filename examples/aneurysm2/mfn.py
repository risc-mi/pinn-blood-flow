...
def run(cfg: ModulusConfig) -> None:
    ...
    center_hardcode = (28.7826, -218.035, -176.655)
    inlet_center_abs_hardcode = (25.7966, -224.301, -182.946)
    inlet_normal_hardcode = ( 0.319237, 0.731749, 0.602189)

    # path definitions
    point_path = to_absolute_path("./stl_files")
    path_inlet = point_path + "/inlet.stl"
    dict_path_outlet = {'path_outlet1': point_path + "/outlet.stl",
                        }
    ...
    flow_net = MultiplicativeFilterNetArch(
    ...
    integral_continuity_0 = IntegralBoundaryConstraint(
        ...
        outvar={"normal_dot_vel": 1.3923 * scale**2},
